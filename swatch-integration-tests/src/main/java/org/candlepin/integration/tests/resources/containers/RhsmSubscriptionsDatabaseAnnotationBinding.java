...
public class RhsmSubscriptionsDatabaseAnnotationBinding extends ContainerAnnotationBinding {
  ...
  public ManagedResource getManagedResource(
    ...
    RhsmSubscriptionsDatabase metadata =
        findAnnotation(annotations, RhsmSubscriptionsDatabase.class).get();

    if (!(service instanceof DatabaseService)) {
      throw new IllegalStateException(
          "@RhsmSubscriptionsDatabase can only be used with DatabaseService service");
    }
